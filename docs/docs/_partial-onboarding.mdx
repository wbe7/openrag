...
Some of these options, such as the models, can be changed in OpenRAG's **Settings** after onboarding is complete.
Other options are immutable and require you to destroy and recreate the OpenRAG containers, as explained in the [OpenRAG environment variables reference](/reference/configuration).
